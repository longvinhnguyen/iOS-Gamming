...
- (id)init {
    ...
    if (self) {
        ...
        NSURL *blockSoundURL = [NSURL fileURLWithPath:[[NSBundle mainBundle] pathForResource:@"0" ofType:@"aiff"]];
        blockPlayer  = [[AVAudioPlayer alloc] initWithContentsOfURL:blockSoundURL error:nil];
        
        NSURL *paddleSoundURL = [NSURL fileURLWithPath:[[NSBundle mainBundle] pathForResource:@"2" ofType:@"aiff"]];
        paddlePlayer = [[AVAudioPlayer alloc] initWithContentsOfURL:paddleSoundURL error:nil];
